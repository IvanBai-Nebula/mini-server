...
class Profile(BaseModel):
    ...
    user = models.ForeignKey(WechatUser, on_delete=models.CASCADE, related_name='profile', db_index=True)
...
class SleepQuality(BaseModel):
    ...
    user = models.ForeignKey(WechatUser, on_delete=models.CASCADE, related_name='sleep_quality',
                             db_index=True)

    class Meta:
        db_table = 'sleep_quality'
